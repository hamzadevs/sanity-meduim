	...
	return (
		<main>
			...
			<article className="mx-auto max-w-3xl p-5">
				...
				<h2 className="front-light mb-2 text-xl text-gray-500">
					{post.description}{" "}
				</h2>
			...
			{submitted ? (
				<div
					className="my-10 mx-auto flex max-w-2xl flex-col
				bg-yellow-500 p-10 text-white"
				>
					<h3 className="text-3xl font-bold">
						Thank you for submtting your comment!
					</h3>
					<p>Once it has been approuved, it will be appear below!</p>
				</div>
			) : (
				<form
				...
				>
					...
					<label className="mb-5 block">
						...
						shadow outline-none  ring-yellow-500 focus:ring-2"
						/>
					</label>
					<label className="mb-5 block">
						...
						px-3 shadow outline-none ring-yellow-500 focus:ring-2"
						/>
					</label>
					<label className="mb-5 block">
						...
						<textarea
							...
							placeholder="Entre some long form content."
							rows={8}
					...
					<input
						type="submit"
						className="bg-yellow-500 py-2 px-4
